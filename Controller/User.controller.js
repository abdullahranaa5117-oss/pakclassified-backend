...
const GetAllUser = async (req, res) => {
  try {
    const GetAllUser = await User.find().select("-SecurityAnswer -SecurityQuestion -ApiKey -OTP -OTPExpire");
...
const GetByIdUser = async (req, res) => {
  try {
    ...
    const found = await User.findById(id).select("-SecurityAnswer -SecurityQuestion -ApiKey -OTP -OTPExpire");
